def divide(quotients, divisors):
    ...
    """
    return {down_: [i for i in divisors if i%down_==0] for down_ in quotients}
    ...
    def add(fruits, amount, cart):
        if fruits == [] and amount == 0:
            ...
            for k in range(1, amount // price + 1):
                ...
                add([i for i in fruits if i!=fruit],amount-k*price, cart+display(fruit,k))
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    tem_city=make_city( 'tem',lat,lon)
    dis1 =distance(tem_city, city_a)
    dis2 =distance(tem_city, city_b)
    return  get_name(city_a if dis1 < dis2 else city_b)
